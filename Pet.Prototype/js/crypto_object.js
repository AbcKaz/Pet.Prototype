...
function openDialog() {
	$("#ncalayernotrun").text("Ошибка к подключению к NCALayer. Убедитесь что  программа запущена и обновите страницу!");
	$("#ncalayerdownload").text("Если у вас не установлен NCALayer скачайте его по ссылке");
	$("#ncalayerdownloadlink").css('display','block');
	
    //if (confirm("Ошибка к подключению к NCALayer. Убедитесь что  программа запущена и нажмите ОК") === true) {
      //  location.reload();
    //}
}
